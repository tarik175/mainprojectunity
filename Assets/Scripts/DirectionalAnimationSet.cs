...
[CreateAssetMenu(fileName = "DirectionalAnimationSet", menuName = "mainproject/DirectionalAnimationSet")]
public class DirectionalAnimationSet : ScriptableObject
{
    ...
    public AnimationClip GetFacingClip(Vector2 facingDirection)
    {
        ...
        {
            throw new ArgumentException($"Invalid direction {closestDirection}");
        }
